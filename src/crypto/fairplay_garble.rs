//! FairPlay garble transformation implemented in safe Rust with explicit wrapping arithmetic.
//!
//! The fixed-width transformation uses register-style names, explicit precedence,
...
pub(crate) fn garble(
    ...
    // Working registers are zero-initialised and then assigned in sequence. The
    // initial stores are why this module allows `unused_assignments`.
    #[rustfmt::skip]
